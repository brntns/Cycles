...
func (s *Server) Routes() http.Handler {
	...
	api.HandleFunc("POST /cycles/{id}/entries", s.handleCreateEntry)
	api.HandleFunc("GET /cycles/{id}/entries", s.handleListEntries)
	api.HandleFunc("DELETE /cycles/{id}/entries/{entryId}", s.handleDeleteEntry)
